...
import 'package:moftah/ui/car_owner/repair/widgets/animated_entrance.dart';
    ...
    return AppBar(
      ...
      title: Row(
        children: [
          ...
          if (widget.data.requestId != null &&
              widget.data.requestDetailsRoute != null)
            IconButton(
              tooltip: 'تفاصيل الطلب',
              onPressed: () {
                Navigator.pushNamed(
                  context,
                  widget.data.requestDetailsRoute!,
                  arguments: widget.data.requestId,
                );
              },
              icon: const Icon(
                    ...
                    children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  customText(
                                    text:
                                        'البلاغ بيروح لفريق الدعم فقط، والفني مش هيشوف تفاصيله.',
                                    fontSize: ResponsiveSize.width(
                                      context,
                                      AppSizes.fontSm,
                                    ),
                      ...
                      ...reasons.map((item) {
                        ...
                        return Padding(
                          ...
                          child: InkWell(
                            onTap: () =>
                                setSheetState(() => selectedReason = item.$1),
                            borderRadius: BorderRadius.circular(
                              AppSizes.radiusSm,
                            ),
                        ...
                        child: FilledButton.icon(
                          style: FilledButton.styleFrom(
                            ...
                            minimumSize: Size.fromHeight(
                              ResponsiveSize.height(context, 5.8),
                            ),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(
                                AppSizes.radiusMd,
                          ...
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(this.context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'تم إرسال بلاغ "$selectedReason" لفريق الدعم',
                                ),
                              ),
                            );
                          },
