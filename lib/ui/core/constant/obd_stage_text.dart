...
String obdStageText(ObdConnectionStage stage) => switch (stage) {
  ...
  ObdConnectionStage.initializingAdapter => 'بنجهز ELM327 بأوامر AT...',
  ObdConnectionStage.detectingProtocol =>
    'بنطلب من ELM327 اكتشاف بروتوكول العربية...',
  ObdConnectionStage.readingVehicle => 'بنتواصل مع ECU ونقرأ بيانات العربية...',
  ObdConnectionStage.ecuNotResponding => 'Bluetooth متصل، لكن ECU لم يرد',
